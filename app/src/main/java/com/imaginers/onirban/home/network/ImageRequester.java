...
import com.imaginers.onirban.home.application.ExigentApplication;
...
public class ImageRequester {
    ...
    private ImageRequester() {
        this.requestQueue = Volley.newRequestQueue(ExigentApplication.getAppContext());
    ...
    private int calculateMaxByteSize() {
        DisplayMetrics displayMetrics = ExigentApplication.getAppContext().getResources().getDisplayMetrics();
