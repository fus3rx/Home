package com.imaginers.onirban.home.network;
...
/**
 * A categories entry in the list of categories.
 */
public class CategoryEntry {
    ...
    /**
     * Loads a raw JSON at R.raw.categories and converts it into a list of CategoryEntry objects
     */
    public static List<CategoryEntry> initCategoryEntryList(Resources resources) {
        ...
        String jsonCategoryString = writer.toString();
        Gson gson = new Gson();
        Type categoryListType = new TypeToken<ArrayList<CategoryEntry>>() {
        }.getType();
        return gson.fromJson(jsonCategoryString, categoryListType);
    }
}